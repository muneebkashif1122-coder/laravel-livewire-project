...
<head>
    <meta charset="utf-8">
    <title>Categories - NEWSROOM</title>
    ...
    <div class="container-fluid py-3">
        <div class="container">
            <div class="d-flex align-items-center justify-content-between bg-light py-2 px-4 mb-3">
                <h3 class="m-0 text-uppercase font-weight-bold">Categories</h3>
            </div>
            ...
            <div class="owl-carousel owl-carousel-2 carousel-item-4 position-relative">
                @foreach($categories as $cat)
                    <div class="position-relative overflow-hidden" style="height: 250px;">
                        @if($cat->displayImage)
                            <img class="img-fluid w-100 h-100" src="{{ asset('storage/' . $cat->displayImage) }}" style="object-fit: cover;">
                        @else
                            <img class="img-fluid w-100 h-100" src="{{ asset('img/cat-500x80-1.jpg') }}" style="object-fit: cover;">
                        @endif
                        <div class="overlay">
                            <a class="h4 m-0 text-white font-weight-bold text-uppercase" href="{{ url('/category/' . $cat->id) }}">
                                {{ $cat->name }}
                            </a>
                            <br>
                            <small class="text-white">View News</small>
                        </div>
                    </div>
                @endforeach
            </div>
